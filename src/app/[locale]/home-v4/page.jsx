...
const departmentData = [
  {
    ...
    subTitle: "Connecting you with the best healthcare professionals in Emergency Department",
...
const pricingData = [
  {
    ...
    price: "$249",
    period: "/month",
    featureList: ["Whole Family Coverage", "Reduced Vaccination Costs", "24/7 Medical Advice"],
    btnText: "Get Started",
    btnUrl: "/contact",
    popular: false,
  },
...
const blogData = [
  ...
  {
    title: "Managing Chronic Pain: Tips and Strategies for a Better Quality of Life",
...
export default function HomeStyle4() {
  return (
    <>
      ...
      >
        <FeaturesSectionStyle5 sectionTitle="Our Values" data={featureListData} />
      </Section>

      <Section topMd={190} topLg={150} topXl={105} bottomMd={200} bottomLg={150} bottomXl={110}>
      ...
      <Section topMd={185} topLg={145} topXl={105} bottomMd={160} bottomLg={110} bottomXl={80}>
        <BlogSectionStyle5
