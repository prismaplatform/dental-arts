...
export const metadata = {
  ...
  description: "DentalArts Sopron - Professzionális fogászati szolgáltatások a szívében Sopronnak. Fogtömés, fogkő eltávolítás, fogfehérítés, implantátum, esztétikai fogászat. Tapasztalt fogorvosok, modern technológia.",
  keywords: [
    "fogászat Sopron",
    "fogorvos Sopron", 
    "DentalArts",
  ...
  openGraph: {
    ...
    description: 'Professzionális fogászati szolgáltatások Sopronban. Tapasztalt fogorvosok, modern technológia, személyre szabott kezelések.',
  ...
  twitter: {
    ...
    title: 'DentalArts Sopron - Modern Fogászati Rendelő',
    description: 'Professzionális fogászati szolgáltatások Sopronban. Tapasztalt fogorvosok, modern technológia.',
